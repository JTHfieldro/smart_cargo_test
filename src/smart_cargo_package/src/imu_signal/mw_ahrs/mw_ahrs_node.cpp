...
void Ahrs::set_subscriber()
{
  _topic_manager->add_subscriber<smart_cargo_package::middle_control_msgs>(
      "smart_cargo/middle_control", 100, &Ahrs::subscribe_middle_control, this);
  _topic_manager->add_subscriber<smart_cargo_package::action_complete_msgs>(
      "smart_cargo/action_complete", 100, &Ahrs::subscribe_action_complete, this);
}

void Ahrs::set_publisher()
{
